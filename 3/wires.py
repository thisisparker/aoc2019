def enumerate_points(l):
    ...
    for move in l:
        ...
        print('moving', distance, 'steps in the direction', direction)

        for step in range(distance):

            new = points[-1].split('x')
